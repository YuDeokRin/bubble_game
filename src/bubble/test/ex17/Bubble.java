...
import bubble.test.ex17.BackgroundBubbleService;
import bubble.test.ex17.Enemy;
import bubble.test.ex17.*;
...
@Getter @Setter
public class Bubble extends JLabel implements Moveable17{

    //의존성 컴포지션
    private BubbleFrame17 mContext;
    ...
    public Bubble(BubbleFrame17 mContext) {
        this.mContext = mContext;
        this.player17 = mContext.getPlayer17();
