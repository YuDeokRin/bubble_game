...
import bubble.test.ex17.BubbleFrame17;
import bubble.test.ex17.EnemyWay;
import bubble.test.ex17.Moveable17;
...
@Getter
@Setter
public class Enemy extends JLabel implements Moveable17 {
    ...
    public Enemy(BubbleFrame17 mContext) {
