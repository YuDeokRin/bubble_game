...
import bubble.test.ex16.BackgroundBubbleService;
...
@Getter @Setter
public class Bubble extends JLabel implements Moveable16{
    ...
    public Bubble(BubbleFrame16 mContext) {
        this.mContext = mContext;
        this.player16 = mContext.getPlayer16();
