...
import bubble.test.ex16.BackgroundPlayerService;
import bubble.test.ex16.Bubble;
import bubble.test.ex16.*;
...
public class Player16 extends JLabel implements Moveable16 {
    ...
    public Player16(BubbleFrame16 mContext) {
