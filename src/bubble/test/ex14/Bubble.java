...
import bubble.test.ex14.BackgroundBubbleService;
...
@Getter @Setter
public class Bubble extends JLabel implements Moveable14{
    ...
    public Bubble(BubbleFrame14 mContext) {
        this.mContext = mContext;
        this.player14 = mContext.getPlayer14();
        initObject();
        initSetting();
    }
