...
import bubble.test.ex18.BackgroundPlayerService;
...
public class Player18 extends JLabel implements Moveable18 {
    ...
    public Player18(BubbleFrame18 mContext) {
    ...
    public void attack(){
        new Thread(()->{
            bubble.test.ex18.Bubble bubble = new Bubble(mContext);
            mContext.add(bubble);
