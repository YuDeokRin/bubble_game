...
import bubble.test.ex18.BubbleFrame18;
import bubble.test.ex18.EnemyWay;
import bubble.test.ex18.Moveable18;
...
@Getter
@Setter
public class Enemy extends JLabel implements Moveable18 {
    ...
    public Enemy(BubbleFrame18 mContext) {
